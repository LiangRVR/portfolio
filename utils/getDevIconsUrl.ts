...
const names = devIconsName.map((icon) =>
   icon.name
);


const IconNameWithSvgTags= devIconsName.reduce((tags: {[k:string]: string[]},icon) =>{
...
const getDevIconUrl = (devIconName: string, svgTag: string): string =>{
