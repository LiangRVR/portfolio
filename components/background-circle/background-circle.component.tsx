...
const BackgroundCircle = () => {
  return (
    ...
    >{/* h-[200px] w-[200px] */}
      ...
      <div className="absolute border border-[#333333] rounded-full h-[45vw] w-[45vw] md:max-h-[300px] md:max-w-[300px] mt-52" />
      <div className="absolute border border-[#333333] rounded-full h-[65vw] w-[65vw] md:max-h-[500px] md:max-w-[500px] mt-52" />
